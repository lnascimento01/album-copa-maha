...
export default function AdminRewardCodeEdit({ rewardCode, teams, albums, statuses, channels }: { rewardCode: RewardCode; teams: Team[]; albums: Album[]; statuses: string[]; channels: string[] }) {
    return (
        <>
