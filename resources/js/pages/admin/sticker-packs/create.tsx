        ...
        <>
            ...
            <div className="space-y-4 p-4">
                ...
                <form onSubmit={submit} className="grid gap-3 rounded-sm border p-4 md:grid-cols-2">
                    ...
                    <div className="md:col-span-2">
                        <button type="submit" className="cursor-pointer rounded-sm border bg-primary px-3 py-2 text-sm text-primary-foreground transition-all hover:brightness-110" disabled={form.processing}>
                            Conceder pacotes
                        </button>
                    </div>
                </form>
