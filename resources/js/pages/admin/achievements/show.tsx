                ...
                {can.grant ? (
                    <form onSubmit={submitGrant} className="grid gap-3 rounded-sm border p-4 md:grid-cols-3">
                        ...
                        <div className="md:col-span-3 flex justify-end">
                            <button type="submit" className="cursor-pointer rounded-sm border bg-primary px-3 py-2 text-sm text-primary-foreground transition-all hover:brightness-110">Conceder</button>
                        </div>
                    </form>
                ) : null}
