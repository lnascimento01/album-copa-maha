            ...
            <div className="space-y-4 p-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div className="flex gap-2">
                        <Link href={`/admin/social-missions/${mission.id}/edit`} className="rounded-sm border px-3 py-2 text-xs">Editar</Link>
                        <button type="button" onClick={activate} className="rounded-sm border px-3 py-2 text-xs">Ativar</button>
                        <button type="button" onClick={closeMission} className="rounded-sm border px-3 py-2 text-xs">Fechar</button>
                        <button type="button" onClick={cancel} className="rounded-sm border px-3 py-2 text-xs">Cancelar</button>
                    </div>
                </div>
