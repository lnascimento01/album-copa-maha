    ...
    return (
        <form onSubmit={submit} className="space-y-4 rounded-sm border p-4">
            ...
            <div className="flex justify-end">
                <button type="submit" disabled={form.processing} className="cursor-pointer rounded-sm border bg-primary px-3 py-2 text-sm text-primary-foreground transition-all hover:brightness-110">{submitLabel}</button>
            </div>
        </form>
    );
}
