...
type Sticker = {
    ...
    album: { id: number; name: string; slug: string; team: { id: number; name: string } };
                ...
                <div className="grid gap-4 md:grid-cols-[280px_1fr]">
                    <div className="rounded-sm border p-3">
                        <div className="aspect-[3/4] rounded-sm border bg-zinc-100 p-2">
                            {sticker.image_path && sticker.is_full_visible ? (
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid gap-3 md:grid-cols-2">
                            ...
                            <div className="rounded-sm border p-4 text-sm"><span className="text-muted-foreground">Time:</span> {sticker.album.team.name}</div>
                        </div>
